...
const buttonVariants = cva(
  'relative group/button inline-flex items-center justify-center whitespace-nowrap transition-colors ease duration-150 disabled:cursor-not-allowed disabled:opacity-50 focus-visible:shadow-focus focus-visible:outline-0',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sidebar: 'w-9 h-9 rounded-md text-sm',
      },
    },
    defaultVariants: {
      variant: 'default',
